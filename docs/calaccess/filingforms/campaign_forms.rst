...
California's Political Reform Act requires political candidates and campaign committees disclosing their contributions and expenditures by filing the forms outlined below. The data collected on these 20 forms are stored in the CAL-ACCESS database.
